...
def __main__():
    parser = argparse.ArgumentParser(description='Pre process the original data')
    parser.add_argument('--png',dest='png', action='store_true', help='If set, images_cropped2 folder with .png images will be created as well')
    ...
    for i in range(FOLDERS):
        ...
        if not os.path.exists(CROPPED_IMG_PATH2 + _it) and args.png:
